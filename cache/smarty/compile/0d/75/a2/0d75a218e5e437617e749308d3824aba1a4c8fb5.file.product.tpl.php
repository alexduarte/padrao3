<?php /* Smarty version Smarty-3.1.14, created on 2014-07-30 12:01:04
         compiled from "C:\wamp\www\padrao3\themes\theme593\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:573553d8faa02604e3-98502808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0d75a218e5e437617e749308d3824aba1a4c8fb5' => 
    array (
      0 => 'C:\\wamp\\www\\padrao3\\themes\\theme593\\product.tpl',
      1 => 1406694523,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '573553d8faa02604e3-98502808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53d8faa2d0eae8_09112340',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53d8faa2d0eae8_09112340')) {function content_53d8faa2d0eae8_09112340($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\padrao3\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_math')) include 'C:\\wamp\\www\\padrao3\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_counter')) include 'C:\\wamp\\www\\padrao3\\tools\\smarty\\plugins\\function.counter.php';
?>
...
<div id="pb-right-column" class="span4">
		<h1 class="pb-right-colum-h"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</h1>
	<!-- product img-->
		<div id="image-block">
...
">
<img id="mousetrap_img" alt="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" width="106" height="106" title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" >
<img id="bigpic" alt="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
">
                       		...
                       		<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['attachment']->value['description'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
"  /></a>
                                    <h5><a class="product_link" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['accessory']->value['name'],22,'...',true), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a></h5>
...
"><span><i class="icon-shopping-cart icon-large"></i><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
</span></a>
                                    <?php }else{ ?>
